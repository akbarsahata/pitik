...
import { Base } from '../datasources/entity/pgsql/Base.entity';
import { DEFAULT_TIME_ZONE } from '../libs/constants';
import { ERR_METHOD_NOT_IMPLEMENTED } from '../libs/constants/errors';
import { RequestUser } from '../libs/types/index.d';

@Service()
export abstract class BaseDAO<T extends ObjectLiteral = Base> {
...
@Service()
export abstract class BaseSQLDAO<T extends ObjectLiteral = Base> extends BaseDAO<T> {
