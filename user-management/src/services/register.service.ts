...
import { RegisterUserItemResponse, RegisterUserRequestBody } from '../dto/register.dto';
...
export class RegisterService {
  ...
  async register(input: RegisterUserRequestBody): Promise<RegisterUserItemResponse> {
    ...
    try {
      ...
      user = await this.dao.getOneStrict({
        where: { id: user.id },
        relations: {
          role: true,
        },
