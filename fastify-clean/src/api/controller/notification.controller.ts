...
export class NotificationController {
  ...
  async getNotifications(request: GetManyNotificationRequest) {
    return this.service.getAllNotificationsByUser(
      {
  ...
  async getNotificationDetailById(request: GetNotificationByIdRequest) {
    return this.service.getNotificationById(request.params.id, request.user);
  }
  ...
  async getUnreadNotificationCount(request: FastifyRequest) {
    return this.service.getUnreadCountByUser(request.user);
  }
  ...
  async readNotifications(request: FastifyRequest) {
    return this.service.readUserNotifications(request.user);
  }
  ...
  async readNotificationById(request: ReadNotificationRequest) {
    return this.service.readUserNotificationById(request.params.id, request.user);
  }
