...
export class BuildingController {
  ...
  async get(
    ...
    const [buildings, count] = await this.service.get(req.query);
  ...
  async detail(
    ...
    const data = await this.service.getById(req.params.buildingId);
  ...
  async update(
    ...
    const data = await this.service.update(req.user, req.body, req.params.buildingId);
  ...
  async getBuildingByCoopId(
    ...
    const [result, count] = await this.service.getBuildingByCoopId(req.params.coopId);
