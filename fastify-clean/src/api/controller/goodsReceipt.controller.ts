...
export class GoodsReceiptController {
  ...
  @POST({
    ...
    options: {
      schema: {
        ...
        response: {
          201: createGoodsReceiptPurchaseOrderResponseDTO,
        },
      },
  ...
  async createGoodsReceiptPurchaseOrder(
    ...
    const data = await this.service.createGoodsReceiptPurchaseOrder(request.body, request.user);
  ...
  @POST({
    ...
    options: {
      schema: {
        ...
        response: {
          201: createGoodsReceiptTransferRequestResponseDTO,
        },
      },
      onRequest: verifyAccess,
    },
  ...
  async createGoodsReceiptTransferRequest(
    ...
    const data = await this.service.createGoodsReceiptTransferRequest(request.body, request.user);
