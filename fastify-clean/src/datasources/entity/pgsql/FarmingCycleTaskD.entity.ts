...
import { FarmingCycleTaskGamificationPoint } from './FarmingCycleTaskGamificationPoint.entity';
...
export class FarmingCycleTaskD extends CMSBase {
  ...
  @OneToMany(() => FarmingCycleTaskGamificationPoint, (fctgp) => fctgp.farmingCycleTask)
  @JoinColumn({ name: 'id', referencedColumnName: 'ref_farmingcycletask_id' })
  gamificationPoint: FarmingCycleTaskGamificationPoint[];
