...
export default async function handler(
  ...
  if (req.method === "GET") {
    await axios({
      method: "GET",
      url: `${process.env.BASE_URL_V2}/rooms/${roomId}`,
      headers: {
    ...
    if (
      ...
      req.body.isCoolingPadExist === undefined ||
      !req.body.buildingId ||
      !req.body.roomTypeId ||
      !req.body.floorTypeId ||
      !req.body.coopId
    ) {
      return res.status(400).json({
        code: 400,
    ...
    await axios({
      ...
      data: {
        ...
        inletWidth: req.body.inletWidth,
        inletLength: req.body.inletLength,
        inletPosition: req.body.inletPosition,
        isActive: req.body.status,
        isCoolingPadExist: req.body.isCoolingPadExist,
        buildingId: req.body.buildingId,
        roomTypeId: req.body.roomTypeId,
        floorTypeId: req.body.floorTypeId,
        controllerTypeId: req.body.controllerTypeId,
        coopId: req.body.coopId,
        heaterInRooms: req.body.heaterInRooms,
        fans: req.body.fans,
      },
      headers: {
        "Content-Type": "application/json",
