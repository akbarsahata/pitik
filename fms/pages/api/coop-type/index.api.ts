...
export default async function handler(
  ...
  if (req.method === "GET") {
    ...
    const { page, limit, status, coopTypeName } = req.query;

    await axios({
      method: "GET",
      url: `${process.env.BASE_URL_V2}/coop-types`,
      params: {
        $page: page,
        $limit: limit,
        status,
    ...
    if (
      !req.body.coopTypeCode ||
      !req.body.coopTypeName ||
    ...
    await axios({
      ...
      url: `${process.env.BASE_URL_V2}/coop-types`,
      data: {
        coopTypeCode: req.body.coopTypeCode,
        coopTypeName: req.body.coopTypeName,
