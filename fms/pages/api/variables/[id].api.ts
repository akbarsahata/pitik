...
export default async function handler(
  ...
  const varId = req.query.id;
  if (req.method === "GET") {
    await axios({
      method: "GET",
      url: `${process.env.BASE_URL_V2}/variables/${varId}`,
      headers: {
    ...
    if (
      !req.body.variableCode ||
      !req.body.variableName ||
      !req.body.variableUOM ||
      !req.body.variableType ||
      req.body.digitComa === undefined ||
      isNaN(req.body.digitComa) ||
    ...
    await axios({
      ...
      data: {
        ...
        variableUOM: req.body.variableUOM,
        variableType: req.body.variableType,
        variableFormula: req.body.variableFormula,
        digitComa: req.body.digitComa,
