...
export default async function handler(
  ...
  const tlId = req.query.id;
  if (req.method === "GET") {
    await axios({
      method: "GET",
      url: `${process.env.BASE_URL_V2}/task-libraries/${tlId}`,
      headers: {
    ...
    if (
      !body.taskCode ||
      !body.taskName ||
      !body.harvestOnly === undefined ||
      !body.manualTrigger === undefined ||
      body.manualDeadline === undefined ||
