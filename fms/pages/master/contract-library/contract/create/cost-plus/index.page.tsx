...
const Create: NextPage = () => {
  ...
  const createCostPlus = useMutation(
    ["createCostPlus"],
    async () => {
      let bopPayload: {
      ...
      await postCreateContractCostPlus({
        customize: false,
        ...
        contractDeductionFcBop: state.deductionFcLoss,
  ...
  if (
    createCostPlus.isSuccess ||
    createCostPlus.isLoading ||
  ...
  return (
    <MainWrapper
      headTitle="Create New Contract Cost Plus"
      pageTitle="Create New Contract Cost Plus"
    >
          ...
          <div className="flex flex-col w-full space-y-6">
            ...
            <div className="flex flex-1 w-full flex-col lg:flex-row items-start justify-start space-y-4 lg:space-y-0 space-x-0 lg:space-x-4">
              ...
              <div className="flex-1 w-full">
                <Input
                  ...
                  className="w-full pl-2 before:content-['Rp']"
                  type="number"
                  state={
            ...
            <div className="flex flex-1 w-full flex-col lg:flex-row items-start justify-start space-y-4 lg:space-y-0 space-x-0 lg:space-x-4">
              ...
              <div className="flex-1 w-full">
                <Input
                  ...
                  type="number"
                  state={
                    state.errorType === ERROR_TYPE.BOP_3_AMOUNT
                      ? "error"
                      : "active"
                  }
              ...
              <div className="flex-1 w-full">
                <Dropdown
                  ...
                  state={
                    state.errorType === ERROR_TYPE.BOP_3_TERM
                      ? "error"
                      : "active"
                  }
            ...
            <div className="flex-1 w-full">
              <Input
                ...
                state={
                  state.errorType === ERROR_TYPE.PRE_BOP_3_IP
                    ? "error"
                    : "active"
                }
                value={
          ...
          <div className="flex flex-col w-full space-y-6">
            ...
            <div className="flex-1 w-full">
              <Input
                ...
                type="number"
                state={
                  state.errorType === ERROR_TYPE.INSENTIVE_DEAL_IP_5
                    ? "error"
                    : "active"
                }
                errorMessage="Please input an IP!"
          ...
          <div className="flex flex-col w-full space-y-6">
            ...
            <div className="flex flex-1 w-full flex-col lg:flex-row items-start justify-start space-y-4 lg:space-y-0 space-x-0 lg:space-x-4">
              ...
              <div className="flex-1 w-full">
                <Input
                  ...
                  type="number"
                  value={
                    state.deductionFcLoss[
                      state.deductionFcLoss.findIndex(
                        (item: TDeductionFcLoss) => item.bop === "1"
                      )
                    ].lossDeductionBop
                  }
                  onChange={(e) => {
                    let arr = [...state.deductionFcLoss];
                    arr[
              ...
              <div className="flex-1 w-full">
                <Input
                  ...
                  value={
                    state.deductionFcLoss[
                      state.deductionFcLoss.findIndex(
                        (item: TDeductionFcLoss) => item.bop === "2"
                      )
                    ].lossDeductionBop
                  }
                  onChange={(e) => {
            ...
            <div className="flex-1 w-full">
              <Input
                ...
                className="w-full px-2 after:content-['%']"
                type="number"
                max="100"
                errorMessage={
                  state.errorType ===
                ...
                value={
                  state.deductionFcLoss[
                    state.deductionFcLoss.findIndex(
                      (item: TDeductionFcLoss) => item.bop === "3"
                    )
                  ].lossDeductionProfit
                }
                onChange={(e) => {
