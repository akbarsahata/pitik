...
const Detail: NextPage = () => {
  ...
  > = useQuery(
    ["contractData"],
    async () => await getContractOwnFarm(contractId),
    {
      enabled: !!state.coopData.length,
  ...
  if (
    ...
    editOwnFarm.isLoading ||
    editOwnFarm.isSuccess
  )
    return <Loading />;
  if (coopData.isError || contractData.isError)
    return <Error router={router} />;

  return (
    <MainWrapper
      headTitle="Edit Own Farm Contract"
      pageTitle="Edit Own Farm Contract"
    >
