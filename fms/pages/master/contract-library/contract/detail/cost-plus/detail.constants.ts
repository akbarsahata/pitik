...
import { TBranchResponse, TDeductionFcBopResponse } from "@type/response.type";
...
export enum ACTION_TYPE {
  ...
  SET_CONTRACT_DEDUCTION_FC_BOP = "SET_CONTRACT_DEDUCTION_FC_BOP",
...
export type ACTIONS =
  ...
  | {
      ...
      payload: typeof store.contractDeductionFcBop;
    }
  | {
