...
const Edit: NextPage = () => {
  ...
  const editCustomMitraGaransi = useMutation(
    ["editCustomMitraGaransi"],
    async () =>
  ...
  if (
    editCustomMitraGaransi.isSuccess ||
    editCustomMitraGaransi.isLoading ||
  ...
  return (
    <MainWrapper
      headTitle="Customized Contract Mitra Garansi"
      pageTitle="Customized Contract Mitra Garansi"
    >
          ...
          <div className="flex flex-1 items-center justify-end space-x-2">
            ...
            <Button
              ...
              onClick={() => {
                ...
                editCustomMitraGaransi.mutate();
              }}
            />
          </div>
        }
        title="Confirmation Edit Custom Contract"
          ...
          <div>
            {confirmationDataModal.data?.data.data.length > 0 ? (
              <div>
                ...
                <p className="mt-2">
                  You need to edit another custom contract for the coop above
                  (if necessary)
                </p>
              </div>
            ) : (
              <div>
                <p>
                  Are you sure want to edit this custom contract? please make
