...
import { CONTROLLER, HEATER, INLET, USER_TYPE } from "@constants/index";
...
import { checkRequired, doCreateCoop } from "./create.functions";
...
const Create: NextPage = () => {
  ...
  return (
    <MainWrapper headTitle="Create New Coop" pageTitle="New Coop">
      ...
      >
        ...
        <Button
          ...
          onClick={async () => {
            ...
            await doCreateCoop({ dispatch, state, router });
          }}
          title="Create Coop"
        />
      </div>
