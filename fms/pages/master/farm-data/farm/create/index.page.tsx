...
const Create: NextPage = () => {
  ...
  if (createFarm.isSuccess || ownerData.isLoading || provinceData.isLoading)
    return <Loading />;

  return (
    <MainWrapper headTitle="Create New Farm" pageTitle="Create New Farm">
      ...
      >
        <Button
          size="xs"
          state={createFarm.isLoading ? "disabled" : "active"}
          type="outline"
          onClick={() => router.back()}
          title="Cancel"
        />
        <Button
          size="xs"
          state={createFarm.isLoading ? "loading" : "active"}
          onClick={() => {
