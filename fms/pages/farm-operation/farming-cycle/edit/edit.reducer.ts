...
export function reducer(store: TStore, action: ACTIONS): TStore {
  switch (action.type) {
    ...
    case ACTION_TYPE.SET_OLD_FARM_START_DATE:
      return { ...store, oldFarmStartDate: action.payload };
    case ACTION_TYPE.SET_INITIAL_WORKER_IDS:
      return { ...store, initialWorkerIds: action.payload };
    ...
    case ACTION_TYPE.SET_FARMING_STATUS:
      return { ...store, farmingStatus: action.payload };
    case ACTION_TYPE.SET_CLOSED_DATE:
      return { ...store, closedDate: action.payload };
    ...
    case ACTION_TYPE.SET_REPOPULATE_REASON:
      return { ...store, repopulateReason: action.payload };
    case ACTION_TYPE.SET_OTHER_REPOPULATE_REASON:
      return { ...store, otherRepopulateReason: action.payload };
    case ACTION_TYPE.SET_APPROVED_AMOUNT:
      return { ...store, approvedAmount: action.payload };
    case ACTION_TYPE.SET_REPOPULATE_DATE:
      return { ...store, repopulateDate: action.payload };
    case ACTION_TYPE.SET_REPOPULATE_DATA:
      return { ...store, repopulateData: action.payload };
    case ACTION_TYPE.SET_IS_REPOPULATION_MODAL_VISIBLE:
      return { ...store, isRepopulationModalVisible: action.payload };
    case ACTION_TYPE.SET_IS_CLOSE_FARMING_CYCLE_MODAL_VISIBLE:
      return { ...store, isCloseFarmingCycleModalVisible: action.payload };
    case ACTION_TYPE.SET_IS_CONFIRMATION_MODAL_VISIBLE:
      return { ...store, isConfirmationModalVisible: action.payload };
    case ACTION_TYPE.SET_IS_WANT_TO_REPOPULATE:
      return { ...store, isWantToRepopulate: action.payload };
    case ACTION_TYPE.SET_TEMP:
      return { ...store, temp: action.payload };
    default:
