...
const Create = () => {
    ...
    async () => {
      await postCreateVendor({
        ...
        purchasableProducts: state.purchasableProducts
          ...
          : [],
        priceBasis: state.priceBasis ? state.priceBasis.value : undefined,
  ...
  if (createVendor.isLoading || createVendor.isSuccess) return <Loading />;
  ...
  return (
    <MainWrapper headTitle="Add New Vendor" pageTitle="Add New Vendor">
      ...
      >
        ...
        <Button
          size="xs"
          state={createVendor.isLoading ? "loading" : "active"}
          onClick={() => {
      ...
      <Modal
        ...
        title="Confirmation Create Vendor"
        isVisible={state.confirmationModalVisible}
        content="Are you sure you want to create this vendor?"
      />
    </MainWrapper>
  );
};
