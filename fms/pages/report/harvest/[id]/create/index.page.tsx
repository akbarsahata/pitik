...
import { TGetManyResponse, THarvestDetailResponse } from "@type/response.type";
        ...
        <div className="flex flex-col items-start justify-start space-y-6">
          <div className="w-full">
            ...
            <Input
              ...
              label="Harvest Date *"
              type="date"
              state={state.errorType === ERROR_TYPE.DATE ? "error" : "active"}
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-0">
            <p className="text-gray-400">
              ...
              provided in the Kartu Timbang (weighing card)
            </p>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          const filteredData = state.records.filter(
                            (e: TWeighingDataPayload) => e.id !== dataTimbang.id
                          );
                          handleOnChangeTotalHarvest(
                            "quantity",
                            0,
