...
import { B2BSmartScaleWeighing } from './b2b/B2BSmartScaleWeighings.entity';
...
export class Room {
  ...
  @OneToMany(() => B2BSmartScaleWeighing, (w) => w.room)
  @JoinColumn({ referencedColumnName: 'ref_room_id' })
  b2bSmartScaleWeighings: B2BSmartScaleWeighing[];

  @OneToMany(() => AiSmartAudioJob, (asaj) => asaj.room)
