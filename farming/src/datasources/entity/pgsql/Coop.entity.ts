...
export class Coop extends CMSBase {
  ...
  @Column({ name: 'purchase_request_sapronak_id', type: 'varchar', length: 32 })
  purchaseRequestSapronakId: string | null;

  @ManyToOne(() => PurchaseRequest)
  @JoinColumn({ name: 'purchase_request_sapronak_id', referencedColumnName: 'id' })
  purchaseRequestSapronak?: PurchaseRequest;
  ...
  @OneToMany(() => B2BFarmInfrastructure, (fi) => fi.coop)
  @JoinColumn({ referencedColumnName: 'id' })
