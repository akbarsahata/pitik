...
export class TransferRequestDAO extends BaseSQLDAO<TransferRequest> {
  ...
  async getOneWithTx(
    params: FindOneOptions<TransferRequest>,
    queryRunner: QueryRunner,
  ): Promise<TransferRequest | null> {
    const data = await queryRunner.manager.findOne(TransferRequest, params);
  ...
  async deleteOneWithTx(
    ...
    const toBeDeleted = await queryRunner.manager.findOneOrFail(TransferRequest, { where: params });

    await queryRunner.manager.delete(TransferRequest, {
      id: toBeDeleted.id,
    });
  ...
  async totalQuantity(
    ...
    const sql = this.repository
      ...
      .andWhere("tr.route IN ('COOP-TO-COOP', 'COOP-TO-BRANCH')");
