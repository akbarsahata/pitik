...
@Service()
export class UserCoreDAO extends BaseSQLDAO<User> {
  ...
  async getOneWithTx(params: FindOneOptions<User>, queryRunner: QueryRunner): Promise<User> {
    const data = await queryRunner.manager.findOneOrFail(User, params);
