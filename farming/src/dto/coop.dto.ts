...
export const coopItemInputDTO = Type.Object({
  ...
  itSupportId: Type.Optional(Type.String()),
  iotEngineerId: Type.Optional(Type.String()),
...
export const coopItemOutputDTO = Type.Object({
  ...
  itSupport: Nullable(userItemDTO),
  iotEngineer: Nullable(userItemDTO),
...
export const idleCoopItemDTO = Type.Object({
  ...
  isOwnFarm: Type.Boolean({ default: false }),
  branch: Nullable(
    Type.Object({
      id: Type.String(),
      name: Type.String(),
