...
export const updateUserBranchByIdParamDTO = Type.Object({
  userId: Type.String(),
});

export const updateUserBranchByIdBodyDTO = Type.Object({
  branchId: Type.String(),
});

export const updateUserBranchByIdResponseDTO = Type.Object({
  code: Type.Number(),
  data: Type.Object({
    message: Type.String(),
  }),
...
export type UpdateUserBranchByIdParam = Static<typeof updateUserBranchByIdParamDTO>;

export type UpdateUserBranchByIdBody = Static<typeof updateUserBranchByIdBodyDTO>;

export type UpdateUserBranchByIdResponse = Static<typeof updateUserBranchByIdResponseDTO>;
