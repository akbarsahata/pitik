...
export const setDeviceAmmoniaSensorBodyDTO = Type.Object({
  macAddress: Type.String(),
});

export const setDeviceAmmoniaSensorResponseItemDTO = Type.Object({
  macAddress: Type.String(),
});

export const setDeviceAmmoniaSensorResponseDTO = Type.Object({
  code: Type.Number(),
  data: setDeviceAmmoniaSensorResponseItemDTO,
});
...
export const getDeviceByMacParamsDTO = Type.Object({
  mac: Type.String(),
});

export const getDeviceByMacResponseDTO = Type.Object({
  code: Type.Number(),
  data: Type.Object({
    id: Type.String(),
    status: Type.Boolean(),
...
export type SetDeviceAmmoniaSensorBody = Static<typeof setDeviceAmmoniaSensorBodyDTO>;

export type SetDeviceAmmoniaSensorResponse = Static<typeof setDeviceAmmoniaSensorResponseDTO>;
...
export type GetDeviceByMacParams = Static<typeof getDeviceByMacParamsDTO>;

export type GetDeviceByMacResponse = Static<typeof getDeviceByMacResponseDTO>;
